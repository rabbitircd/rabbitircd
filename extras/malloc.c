...
* Synopsis of compile-time options:
    ...
    Linux.  People also report using it in stand-alone embedded systems.
    ...
    LACKS_UNISTD_H             NOT defined
    LACKS_SYS_PARAM_H          NOT defined
    LACKS_SYS_MMAN_H           NOT defined
...
/*
  ...
  alternative MORECORE functions, as well as a sample version for
  pre-OSX macos.
*/
...
/* ------------------------------------------------------------
History:
    V3.4.0 Sun Sep 15 17:15:00 2013  Falcon Darkstar Momot
      * Expunge windows code entirely and remove logs for it below
    ...
    V2.6.6 Sun Dec  5 07:42:19 1999  Doug Lea  (dl at gee)
      ...
      * Added Several cleanups from Martin C. Fong <mcfong at yahoo.com>
